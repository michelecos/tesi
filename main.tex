...
\documentclass[ twoside,openright,titlepage,fleqn,numbers=noenddot,headinclude,%1headlines,% 
                11pt,a4paper,BCOR5mm,footinclude,clearpage=empty,abstractoff % <--- obsolete, remove (todo)
                ]{scrreprt}
...
% ********************************************************************
\newcommand{\myTitle}{Combustibili per reattori nucleari di terza generazione\xspace}
...
% ********************************************************************
% Una macro per la scrittura di nuclidi
%*******************************************************
\newcommand{\nucl}[3]{
	\ensuremath{
...
%*******************************************************
\graphicspath{{Graphics/}}% considered harmful according to l2tabu
...
%\clearpage\include{FrontBackmatter/Publication}
